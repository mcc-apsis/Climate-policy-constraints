...
##### select variables
vars <- c("gini_disp","frac_ethnic","trust","rrents_tot_WB","ene_share_coal","ene_share_oil","ene_share_gas","gov_corrupt_WGI","gov_effect_WGI")
group <- c("social","social","social","political","political","political","political","capacity","capacity")
...
```{r time_trends,echo=FALSE,warning=FALSE,fig.width=8,fig.height=8,fig.path="Results/Plots/",dev=c('png','pdf')}
